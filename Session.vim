...
exe 'vert 2resize ' . ((&columns * 37 + 74) / 149)
...
46
normal! zo
let s:l = 177 - ((24 * winheight(0) + 22) / 45)
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 291 - ((29 * winheight(0) + 22) / 45)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
291
...
wincmd w
argglobal
edit assets/js/cookieConfig.js
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
wincmd w
argglobal
edit assets/js/KeyModifiers.js
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
