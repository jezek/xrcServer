...
set shortmess=aoO
badd +80 xrcServer.go
badd +1 assets/css/style.css
badd +1 assets/js/init.js
badd +1 assets/js/TouchPad.js
badd +1 assets/js/TouchButton.js
badd +1 assets/js/KeyInput.js
badd +1 assets/js/KeyModifiers.js
badd +22 assets/js/helpers.js
badd +1 assets/js/Tabs.js
badd +1 assets/js/Keys.js
badd +255 handlers.go
badd +1 assets/index.tmpl
badd +20 assets/js/cookieConfig.js
badd +1 assets/pair.tmpl
badd +6 assets/js/pair.js
badd +217 pair.go
badd +152 /usr/local/go/src/time/sleep.go
badd +44 assets.go
argglobal
silent! argdel *
set stal=2
...
exe 'vert 1resize ' . ((&columns * 1 + 74) / 149)
exe 'vert 2resize ' . ((&columns * 1 + 74) / 149)
exe 'vert 3resize ' . ((&columns * 145 + 74) / 149)
argglobal
...
let s:l = 78 - ((20 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
78
normal! 014|
lcd ~/Programy/go/src/xrcServer
wincmd w
argglobal
if bufexists('~/Programy/go/src/xrcServer/pair.go') | buffer ~/Programy/go/src/xrcServer/pair.go | else | edit ~/Programy/go/src/xrcServer/pair.go | endif
nnoremap <buffer> <silent>  :call go#def#StackPop(v:count1)
nnoremap <buffer> <silent> ] :call go#def#Jump("split")
nnoremap <buffer> <silent>  :call go#def#Jump("split")
nnoremap <buffer> <silent>  :GoDef
...
182
normal! zo
let s:l = 199 - ((33 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
199
...
wincmd w
argglobal
if bufexists('~/Programy/go/src/xrcServer/handlers.go') | buffer ~/Programy/go/src/xrcServer/handlers.go | else | edit ~/Programy/go/src/xrcServer/handlers.go | endif
nnoremap <buffer> <silent>  :call go#def#StackPop(v:count1)
nnoremap <buffer> <silent> ] :call go#def#Jump("split")
nnoremap <buffer> <silent>  :call go#def#Jump("split")
nnoremap <buffer> <silent>  :GoDef
...
exe 'vert 2resize ' . ((&columns * 1 + 74) / 149)
exe 'vert 3resize ' . ((&columns * 145 + 74) / 149)
tabedit ~/Programy/go/src/xrcServer/assets/index.tmpl
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
exe 'vert 1resize ' . ((&columns * 84 + 74) / 149)
exe '2resize ' . ((&lines * 31 + 20) / 41)
exe 'vert 2resize ' . ((&columns * 84 + 74) / 149)
exe 'vert 3resize ' . ((&columns * 64 + 74) / 149)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
setlocal indentkeys=o,O,<Return>,<>>,{,},!^F,=else,=end
setlocal noinfercase
setlocal iskeyword=@,48-57,_,192-255
setlocal keywordprg=
setlocal nolinebreak
...
wincmd w
argglobal
if bufexists('~/Programy/go/src/xrcServer/assets/pair.tmpl') | buffer ~/Programy/go/src/xrcServer/assets/pair.tmpl | else | edit ~/Programy/go/src/xrcServer/assets/pair.tmpl | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists('~/Programy/go/src/xrcServer/assets/css/style.css') | buffer ~/Programy/go/src/xrcServer/assets/css/style.css | else | edit ~/Programy/go/src/xrcServer/assets/css/style.css | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
exe 'vert 2resize ' . ((&columns * 84 + 74) / 149)
exe 'vert 3resize ' . ((&columns * 64 + 74) / 149)
tabedit ~/Programy/go/src/xrcServer/assets/js/init.js
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
exe '3resize ' . ((&lines * 32 + 20) / 41)
exe 'vert 3resize ' . ((&columns * 74 + 74) / 149)
exe '4resize ' . ((&lines * 6 + 20) / 41)
exe 'vert 4resize ' . ((&columns * 74 + 74) / 149)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
wincmd w
argglobal
if bufexists('~/Programy/go/src/xrcServer/assets/js/pair.js') | buffer ~/Programy/go/src/xrcServer/assets/js/pair.js | else | edit ~/Programy/go/src/xrcServer/assets/js/pair.js | endif
setlocal keymap=
setlocal noarabic
...
wincmd w
argglobal
if bufexists('~/Programy/go/src/xrcServer/assets/js/helpers.js') | buffer ~/Programy/go/src/xrcServer/assets/js/helpers.js | else | edit ~/Programy/go/src/xrcServer/assets/js/helpers.js | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists('~/Programy/go/src/xrcServer/assets/js/cookieConfig.js') | buffer ~/Programy/go/src/xrcServer/assets/js/cookieConfig.js | else | edit ~/Programy/go/src/xrcServer/assets/js/cookieConfig.js | endif
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
exe '4resize ' . ((&lines * 6 + 20) / 41)
exe 'vert 4resize ' . ((&columns * 74 + 74) / 149)
tabedit ~/Programy/go/src/xrcServer/assets/js/Tabs.js
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
wincmd w
argglobal
if bufexists('~/Programy/go/src/xrcServer/assets/js/TouchPad.js') | buffer ~/Programy/go/src/xrcServer/assets/js/TouchPad.js | else | edit ~/Programy/go/src/xrcServer/assets/js/TouchPad.js | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists('~/Programy/go/src/xrcServer/assets/js/TouchButton.js') | buffer ~/Programy/go/src/xrcServer/assets/js/TouchButton.js | else | edit ~/Programy/go/src/xrcServer/assets/js/TouchButton.js | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
exe '3resize ' . ((&lines * 8 + 20) / 41)
exe 'vert 3resize ' . ((&columns * 74 + 74) / 149)
tabedit ~/Programy/go/src/xrcServer/assets/js/KeyInput.js
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
wincmd w
argglobal
if bufexists('~/Programy/go/src/xrcServer/assets/js/KeyModifiers.js') | buffer ~/Programy/go/src/xrcServer/assets/js/KeyModifiers.js | else | edit ~/Programy/go/src/xrcServer/assets/js/KeyModifiers.js | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists('~/Programy/go/src/xrcServer/assets/js/Keys.js') | buffer ~/Programy/go/src/xrcServer/assets/js/Keys.js | else | edit ~/Programy/go/src/xrcServer/assets/js/Keys.js | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
