...
badd +1 handlers.go
badd +17 assets/index.tmpl
badd +20 assets/js/cookieConfig.js
badd +0 assets/pair.tmpl
badd +0 assets/js/pair.js
argglobal
silent! argdel *
set stal=2
edit xrcServer.go
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 288 - ((29 * winheight(0) + 22) / 45)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
288
...
exe 'vert 2resize ' . ((&columns * 75 + 74) / 149)
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 10 - ((7 * winheight(0) + 11) / 22)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
10
...
wincmd t
set winheight=1 winwidth=1
exe 'vert 1resize ' . ((&columns * 59 + 74) / 149)
exe '2resize ' . ((&lines * 7 + 23) / 47)
exe 'vert 2resize ' . ((&columns * 89 + 74) / 149)
exe '3resize ' . ((&lines * 18 + 23) / 47)
exe 'vert 3resize ' . ((&columns * 89 + 74) / 149)
exe '4resize ' . ((&lines * 18 + 23) / 47)
exe 'vert 4resize ' . ((&columns * 89 + 74) / 149)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
wincmd t
set winheight=1 winwidth=1
exe '1resize ' . ((&lines * 5 + 23) / 47)
exe 'vert 1resize ' . ((&columns * 138 + 74) / 149)
exe '2resize ' . ((&lines * 2 + 23) / 47)
exe 'vert 2resize ' . ((&columns * 12 + 74) / 149)
exe '3resize ' . ((&lines * 2 + 23) / 47)
exe 'vert 3resize ' . ((&columns * 12 + 74) / 149)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
