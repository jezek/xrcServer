...
wincmd t
set winminheight=1 winheight=1 winminwidth=1 winwidth=1
exe 'vert 1resize ' . ((&columns * 63 + 62) / 125)
exe 'vert 2resize ' . ((&columns * 59 + 62) / 125)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 117 - ((92 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
117
