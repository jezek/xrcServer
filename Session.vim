...
let s:l = 50 - ((11 * winheight(0) + 19) / 39)
...
168
normal! zo
let s:l = 177 - ((5 * winheight(0) + 9) / 19)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
177
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 307 - ((11 * winheight(0) + 9) / 19)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
307
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 10 - ((1 * winheight(0) + 16) / 33)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
10
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 22 - ((10 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
22
